...
//                                                 .contentType(ContentType.JSON);
        ...
        //we replace above coding to the SpartanNewBase util

        given()
                .spec(reqSpec) //from SpartanNewBase util
                //'.spec' is a special word for RequestSpecification class
                .when()
                .get("/spartans")
                .then()
                .spec(responseSpec);//from SpartanNewBase util
    }

    @Test
    public void test2(){
        given()
                .spec(userSpec)//from SpartanNewBase util
                .and()
                .pathParam("id",8)
                .when()
                .get("/spartans/{id}")
