    ...
    public class JsonSchemaValidationTest extends SpartanAuthTestBase {
        ...
        public void test1(){
            ...
            given()
                    ...
                    //dedicated tool to match and validate Json schema with Json body
             //we indicate also file with schema which is to be match with our Json body
                    .log().all();
        ...
        public void test2(){
            given()
                    ...
                    .body(JsonSchemaValidator.matchesJsonSchema
                     ...
                     //indicate new File object with full path in our framework
