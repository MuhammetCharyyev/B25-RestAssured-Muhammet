...
public class HrHamcrestTests extends HrTestBase {
    ...
    public void test1() {
        ...
        given()
                ...
                //checking all job_id in 'items' and look for every item equals to IT_PROG
                .body("items.salary" , everyItem(greaterThan(5000)))
                //checking all salary in 'items' and look for every item greater 5000
                .body("items.first_name", equalTo(names))
                //equalTo looking for exact matching of out List
...
//it used when we want to save our variable and use it later as below, for example
