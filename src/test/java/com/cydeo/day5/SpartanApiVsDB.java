...
public class SpartanApiVsDB extends SpartanTestBase {
    ...
    public void test1() {
      ...
      Map<String,Object> apiMap =  response.as(Map.class);//Map from API
        ...
        Map<String, Object> dbMap = DB_Utils.getRowMap(query);//Map from DB

        System.out.println(dbMap);

        //compare api vs db/ i.e. actual(api) vs expected(db)
